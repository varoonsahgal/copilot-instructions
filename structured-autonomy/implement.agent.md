...
- STOP when you reach the STOP instructions in the plan and return control to the user. If no STOP instructions, just STOP after completing the final step.  Do not do any work after that, return control to the user.
</workflow>
